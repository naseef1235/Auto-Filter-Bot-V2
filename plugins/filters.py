...
async def filter(client: Bot, message: Message):
    ...
    if 2 < len(message.text) < 50:    
        ...
        await message.reply_text(
                f"<b> Your Requested movie {message.text}</b>",
                reply_markup=InlineKeyboardMarkup(buttons)
            )    
    ...
    if (clicked == typed) or (clicked in AUTH_USERS):
        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("Movie request Group", url="https://t.me/CFCHART")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("BACK", callback_data="start_data"),
                    InlineKeyboardButton("ABOUT", callback_data="about_data")],
                [InlineKeyboardButton("Movie Request Group", url="https://t.me/TroJanzSupport")]
            ])
